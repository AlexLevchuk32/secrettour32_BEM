...
// Кнопка Наверх
let goUpBtn = document.querySelector(".up-btn");
...
let offerBtn = document.querySelector(".header__btn");
let form = document.querySelector(".fidback-form");
...
let closeButton = document.querySelector(".fidback-form__close-btn");
...
let fidbackFormLink = document.querySelector(".fidback-form__link");
let soglasieForm = document.querySelector(".soglasie");
...
let closeBtnSoglasie = document.querySelector(".soglasie__close-btn");
